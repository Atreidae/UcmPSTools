Function Test-EXHOConnection
{
	<#
			...
			.DESCRIPTION
			Tries to pull tenant info and will call New-EXHOConnection if unsucsessful
...
Write-Host '' #Insert a blank line to make reading output easier on loops
	...
	Write-Log -Message "Checking for Existing EXHO Connection" -Severity 1 -Component $function
