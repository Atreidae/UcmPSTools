...
Function Disable-UcmO365Service
{
  <#
      .SYNOPSIS
      Disables a Specified Service Plan in Office365

      .DESCRIPTION
      Cmdlet uses an existing Azure AD connection to filter through a users licences and disables the requested service.
      ...
      .VERSION HISTORY
      1.4: Replicated for Disable-UcmO365Service
